            ...
            <div id="game_container">
                ...
                <div id="answers_container">
                    <div id="answer_1_container" class="answer_container">
                        ...
                        <button id="re_answer_1_button" class="answer_button" onclick="hideAnswer(1)" value="1">Hide</button>
                    ...
                    <div id="answer_2_container" class="answer_container">
                        ...
                        <button id="re_answer_2_button" class="answer_button" onclick="hideAnswer(2)" value="2">Hide</button>
                    ...
                    <div id="answer_3_container" class="answer_container">
                        ...
                        <button id="re_answer_3_button" class="answer_button" onclick="hideAnswer(3)" value="3">Hide</button>
                    ...
                    <div id="answer_4_container" class="answer_container">
                        ...
                        <button id="re_answer_4_button" class="answer_button" onclick="hideAnswer(4)" value="4">Hide</button>
                    ...
                    <div id="answer_5_container" class="answer_container">
                        ...
                        <button id="re_answer_5_button" class="answer_button" onclick="hideAnswer(5)" value="2">Hide</button>
                    ...
                    <div id="answer_6_container" class="answer_container">
                        ...
                        <button id="re_answer_6_button" class="answer_button" onclick="hideAnswer(6)" value="6">Hide</button>
                    ...
                    <div id="answer_7_container" class="answer_container">
                        ...
                        <button id="re_answer_7_button" class="answer_button" onclick="hideAnswer(7)" value="7">Hide</button>
                    ...
                    <div id="answer_8_container" class="answer_container">
                        ...
                        <button id="re_answer_8_button" class="answer_button" onclick="hideAnswer(8)" value="8">Hide</button>
                    ...
                    <div id="answer_9_container" class="answer_container">
                        ...
                        <button id="re_answer_9_button" class="answer_button" onclick="hideAnswer(9)" value="9">Hide</button>
                    ...
                    <div id="answer_10_container" class="answer_container">
                        ...
                        <button id="re_answer_10_button" class="answer_button" onclick="hideAnswer(10)" value="10">Hide</button>
